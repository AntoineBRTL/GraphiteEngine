...
This engine is developped in Typescript and can run in a browser and Electron. The engine is powered by WebGL and WebGPU and no external libraries are required to run the engine.
