...
export class Renderer {
    setPremitiveType(premitiveType) {
    ...
    constructor() {
        ...
        if (!tmpgl)
            throw new Error("can't create GL context");
        this.gl = tmpgl;
