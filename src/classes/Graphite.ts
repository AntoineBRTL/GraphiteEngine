...
export let inputThread: Thread = new Thread(Thread.ENGINE_DEFAULT_TARGET_FRAMERATE);
export let renderThread: Thread = new Thread(Thread.ENGINE_DEFAULT_TARGET_FRAMERATE);
